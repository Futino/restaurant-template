    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          {
            light:
              "rgb(var(--md-sys-color-inverse-primary-light)/ <alpha-value>) ",
            dark: "rgb(var(--md-sys-color-on-primary-container-dark) / <alpha-value>) ",
          }
        },
        ...
        background: {
          light:
            "rgb(var(--md-sys-color-background-light)/ <alpha-value>) ",
        ...
        {
          light:
            "rgb(var(--md-sys-color-outline-light)/ <alpha-value>) ",
        ...
        error: {
          light:
            "rgb(var(--md-sys-color-error-light)/ <alpha-value>) ",
          dark: "rgb(var(--md-sys-color-error-dark) / <alpha-value>) ",
          on: {
            light:
              "rgb(var(--md-sys-color-on-error-light)/ <alpha-value>) ",
